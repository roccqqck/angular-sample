...
export class Form2Component implements OnInit {
  ...
  get form2Data() {
    return{
      ...
      usrId: this.f1003Service.getUsrId(),
      usrTipId:this.f1003Service.getUsrIdTip(),
      transDttm:this.f1003Service.getTransDttm()
    }
  };

  get errorMessage() {return this.f1003Service.getError();}
